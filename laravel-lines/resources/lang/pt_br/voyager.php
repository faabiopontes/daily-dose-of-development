...
return [
    ...
    'error' => [
        'symlink_created_text'   => 'Acabamos de criar o link simbólico (symlink) faltando para você.',
        'symlink_created_title'  => 'Um link simbólico (symlink) de armazenamento faltante foi criado',
        ...
        'symlink_missing_text'   => 'Não foi possível encontrar um link simbólico (symlink) de armazenamento. Isso pode causar problemas ao carregar os arquivos de mídia do navegador.',
